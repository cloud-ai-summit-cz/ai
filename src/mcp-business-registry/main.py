"""Entry point for MCP Business Registry server."""
...
if connection_string:
    try:
        ...
        configure_azure_monitor(
            ...
            service_name="mcp-business-registry",
            enable_live_metrics=True,
        )
        FastAPIInstrumentor.instrument()
        logger.info("Azure Monitor telemetry configured for mcp-business-registry")
