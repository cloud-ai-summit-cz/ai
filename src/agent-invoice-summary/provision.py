"""Agent provisioner for Invoice Summary.

Creates and destroys the invoice-process-summary-agent in Azure AI Foundry Agent Service.
This agent summarizes the invoice processing results and determines next steps.
"""
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="provision.py",
        description="Provision and manage the Invoice Summary agent in Azure AI Foundry.",
    )
...
def create_agent() -> None:
    """Create the invoice-process-summary-agent in AI Foundry.
...
def destroy_agent() -> None:
    """Destroy the invoice-process-summary-agent."""
