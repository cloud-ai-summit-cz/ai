...
Evaluates financial viability of Cofilot's expansion through cost analysis, revenue projections, and ROI calculations.
...
- Injects MCP tools at runtime (scratchpad, calculator, real-estate, government-data, business-registry)
...
Examples:
- `finance-analyst-a2a-maf`
- `finance-analyst-a2a-langgraph`
- `finance-analyst-foundry-maf`
- `finance-analyst-foundry-langgraph`
...
- **mcp-business-registry**: Company financials for benchmarking
