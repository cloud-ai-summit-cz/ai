"""Configuration for standalone Finance Analyst A2A Agent."""
...
class Settings(BaseSettings):
    ...
    # MCP Calculator Configuration (primary tool for financial calculations)
    mcp_calculator_url: str
    mcp_calculator_api_key: str

    # MCP Real Estate Configuration
    mcp_real_estate_url: str
    mcp_real_estate_api_key: str

    # MCP Government Data Configuration
    mcp_government_data_url: str
    mcp_government_data_api_key: str

    # MCP Business Registry Configuration
    ...
    a2a_agent_name: str = "Finance Analyst Agent"
    a2a_agent_description: str = (
        "Financial analysis specialist for Cofilot's coffee business expansion. "
        "Provides comprehensive financial viability analysis including startup costs, "
        "operating expenses, revenue projections, break-even analysis, ROI, NPV, "
        "cash flow projections, and sensitivity analysis for potential locations."
    )
