"""Configuration for standalone Market Analyst A2A Agent."""
...
class Settings(BaseSettings):
    ...
    a2a_agent_name: str = "Market Analyst Agent"
    a2a_agent_description: str = (
        "Market analysis specialist for Cofilot's coffee business expansion. "
        "Provides market sizing, consumer behavior analysis, customer segmentation, "
        "and industry dynamics insights for specialty coffee markets in Brno and Vienna."
    )
