"""Configuration for standalone Synthesizer A2A Agent."""
...
class Settings(BaseSettings):
    ...
    # MCP Scratchpad Configuration (for reading research findings and writing synthesis)
    mcp_scratchpad_url: str
    mcp_scratchpad_api_key: str

    # MCP Calculator Configuration (for financial calculations in synthesis)
    mcp_calculator_url: str
    mcp_calculator_api_key: str

    # A2A Server Configuration
    a2a_server_host: str = "0.0.0.0"
    a2a_server_port: int = 8024
    ...
    a2a_agent_name: str = "Synthesizer Agent"
    a2a_agent_description: str = (
        "Research synthesis specialist for Cofilot's coffee business expansion. "
        "Compiles findings from market, competitor, location, and finance analysts "
        "into comprehensive expansion reports with strategic recommendations."
    )
    ...
    def prompts_dir(self) -> Path:
        ...
        # Default: navigate from standalone/a2a/maf/ up to agent-synthesizer/prompts/
