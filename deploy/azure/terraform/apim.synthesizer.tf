# ============================================================================
# Azure API Management - A2A Agent: Synthesizer
# ============================================================================
# Registers the Synthesizer agent as an A2A (Agent-to-Agent) API in APIM.
...
# ============================================================================
# Local Variables for Synthesizer Agent
# ============================================================================
...
locals {
  ...
  synthesizer_backend_url = "https://${azapi_resource.capp_agent_synthesizer_a2a.output.properties.configuration.ingress.fqdn}"
}
...
resource "azapi_resource" "apim_api_a2a_synthesizer" {
  type      = "Microsoft.ApiManagement/service/apis@2024-10-01-preview"
  name      = "${local.synthesizer_agent_id}-${random_string.suffix.result}"
  parent_id = azapi_resource.apim.id

  body = {
    properties = {
      displayName = local.synthesizer_agent_name
      description = ""
      path        = local.synthesizer_agent_name
      protocols   = ["https"]
      ...
      agent = {
        id                  = local.synthesizer_agent_id
        name                = local.synthesizer_agent_name
        managementPortalUrl = ""
        providerName        = null
      }
      ...
      a2aProperties = {
        agentCardBackendUrl = "${local.synthesizer_backend_url}/.well-known/agent-card.json"
        agentCardPath       = "/agent-card.json"
      }

      # JSON-RPC backend configuration
      jsonRpcProperties = {
        backendUrl = local.synthesizer_backend_url
        path       = "/"
      }
  ...
  depends_on = [
    azapi_resource.apim,
    azapi_resource.capp_agent_synthesizer_a2a
  ]
}
...
resource "azapi_resource" "apim_operation_a2a_synthesizer_get" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "get"
  parent_id = azapi_resource.apim_api_a2a_synthesizer.id
...
resource "azapi_resource" "apim_operation_a2a_synthesizer_post" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "post"
  parent_id = azapi_resource.apim_api_a2a_synthesizer.id
...
resource "azapi_resource" "apim_operation_a2a_synthesizer_put" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "put"
  parent_id = azapi_resource.apim_api_a2a_synthesizer.id
...
resource "azapi_resource" "apim_operation_a2a_synthesizer_delete" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "delete"
  parent_id = azapi_resource.apim_api_a2a_synthesizer.id
...
resource "azapi_resource" "apim_operation_a2a_synthesizer_patch" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "patch"
  parent_id = azapi_resource.apim_api_a2a_synthesizer.id
...
resource "azapi_resource" "apim_operation_a2a_synthesizer_head" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "head"
  parent_id = azapi_resource.apim_api_a2a_synthesizer.id
...
resource "azapi_resource" "apim_operation_a2a_synthesizer_options" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "options"
  parent_id = azapi_resource.apim_api_a2a_synthesizer.id
...
resource "azapi_resource" "apim_api_a2a_synthesizer_policy" {
...
<policies>
  ...
  depends_on = [
    azapi_resource.apim_operation_a2a_synthesizer_get,
    azapi_resource.apim_operation_a2a_synthesizer_post,
    azapi_resource.apim_operation_a2a_synthesizer_put,
    azapi_resource.apim_operation_a2a_synthesizer_delete,
    azapi_resource.apim_operation_a2a_synthesizer_patch,
    azapi_resource.apim_operation_a2a_synthesizer_head,
    azapi_resource.apim_operation_a2a_synthesizer_options
  ]
