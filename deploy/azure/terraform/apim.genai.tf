# ============================================================================
# Azure API Management - GenAI Gateway Resources
# ============================================================================
# This file contains APIM resources for the AI Gateway integration:
# - Azure OpenAI API and operations
# - Foundry agents subscription
# - Policies for OpenAI and model discovery endpoints
