# Container App for Market Analyst A2A Agent
# This agent uses Microsoft Agent Framework with A2A protocol

resource "azapi_resource" "capp_agent_market_analyst_a2a" {
  type      = "Microsoft.App/containerApps@2024-03-01"
  name      = "ca-agent-market-analyst-a2a"
        ...
        containers = [
          {
            ...
            image = local.agent_market_analyst_a2a_image
            resources = {
            ...
            env = [
              ...
              },
              {
                ...
                value = "ca-agent-market-analyst-a2a.${azapi_resource.container_app_environment.output.properties.defaultDomain}"
              },
              {
                name      = "A2A_API_KEY"
...
output "agent_market_analyst_a2a_url" {
  description = "The public URL of the Market Analyst A2A Agent"
  value       = "https://ca-agent-market-analyst-a2a.${azapi_resource.container_app_environment.output.properties.defaultDomain}"
}
