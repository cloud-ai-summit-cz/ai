# ============================================================================
# Azure API Management - A2A Agent: Finance Analyst
# ============================================================================
# Registers the Finance Analyst agent as an A2A (Agent-to-Agent) API in APIM.
...
# ============================================================================
# Local Variables for Finance Analyst Agent
# ============================================================================

locals {
  # Agent configuration
  finance_analyst_agent_id   = "finance-analyst"
  finance_analyst_agent_name = "finance-analyst"

  # Backend URL from Container App (the actual agent endpoint)
  finance_analyst_backend_url = "https://${azapi_resource.capp_agent_finance_analyst_a2a.output.properties.configuration.ingress.fqdn}"
}
...
resource "azapi_resource" "apim_api_a2a_finance_analyst" {
  type      = "Microsoft.ApiManagement/service/apis@2024-10-01-preview"
  name      = "${local.finance_analyst_agent_id}-${random_string.suffix.result}"
  parent_id = azapi_resource.apim.id

  body = {
    properties = {
      displayName = local.finance_analyst_agent_name
      description = ""
      path        = local.finance_analyst_agent_name
      protocols   = ["https"]
      ...
      agent = {
        id                  = local.finance_analyst_agent_id
        name                = local.finance_analyst_agent_name
        managementPortalUrl = ""
        providerName        = null
      }
      ...
      a2aProperties = {
        agentCardBackendUrl = "${local.finance_analyst_backend_url}/.well-known/agent-card.json"
        agentCardPath       = "/agent-card.json"
      }

      # JSON-RPC backend configuration
      jsonRpcProperties = {
        backendUrl = local.finance_analyst_backend_url
        path       = "/"
      }
  ...
  depends_on = [
    azapi_resource.apim,
    azapi_resource.capp_agent_finance_analyst_a2a
  ]
}
...
resource "azapi_resource" "apim_operation_a2a_finance_analyst_get" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "get"
  parent_id = azapi_resource.apim_api_a2a_finance_analyst.id
...
resource "azapi_resource" "apim_operation_a2a_finance_analyst_post" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "post"
  parent_id = azapi_resource.apim_api_a2a_finance_analyst.id
...
resource "azapi_resource" "apim_operation_a2a_finance_analyst_put" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "put"
  parent_id = azapi_resource.apim_api_a2a_finance_analyst.id
...
resource "azapi_resource" "apim_operation_a2a_finance_analyst_delete" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "delete"
  parent_id = azapi_resource.apim_api_a2a_finance_analyst.id
...
resource "azapi_resource" "apim_operation_a2a_finance_analyst_patch" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "patch"
  parent_id = azapi_resource.apim_api_a2a_finance_analyst.id
...
resource "azapi_resource" "apim_operation_a2a_finance_analyst_head" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "head"
  parent_id = azapi_resource.apim_api_a2a_finance_analyst.id
...
resource "azapi_resource" "apim_operation_a2a_finance_analyst_options" {
  type      = "Microsoft.ApiManagement/service/apis/operations@2024-10-01-preview"
  name      = "options"
  parent_id = azapi_resource.apim_api_a2a_finance_analyst.id
...
resource "azapi_resource" "apim_api_a2a_finance_analyst_policy" {
...
<policies>
  ...
  depends_on = [
    azapi_resource.apim_operation_a2a_finance_analyst_get,
    azapi_resource.apim_operation_a2a_finance_analyst_post,
    azapi_resource.apim_operation_a2a_finance_analyst_put,
    azapi_resource.apim_operation_a2a_finance_analyst_delete,
    azapi_resource.apim_operation_a2a_finance_analyst_patch,
    azapi_resource.apim_operation_a2a_finance_analyst_head,
    azapi_resource.apim_operation_a2a_finance_analyst_options
  ]
