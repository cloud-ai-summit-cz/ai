# Container App for MCP Business Registry
resource "azapi_resource" "capp_mcp_business_registry" {
  type      = "Microsoft.App/containerApps@2024-03-01"
  name      = "ca-mcp-business-registry"
        ...
        containers = [
          {
            ...
            image = local.mcp_business_registry_image
            resources = {
