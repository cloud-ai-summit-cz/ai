# Container App for Competitor Analyst A2A Agent
# This agent uses Microsoft Agent Framework with A2A protocol
# Uses MCP Business Registry, MCP Scratchpad, and Grounded Web Search (Bing)

resource "azapi_resource" "capp_agent_competitor_analyst_a2a" {
  type      = "Microsoft.App/containerApps@2024-03-01"
  name      = "ca-agent-competitor-analyst-a2a"
        ...
        containers = [
          {
            ...
            image = local.agent_competitor_analyst_a2a_image
            resources = {
            ...
            env = [
              ...
              },
              {
                ...
                value = "ca-agent-competitor-analyst-a2a.${azapi_resource.container_app_environment.output.properties.defaultDomain}"
              },
              {
                name      = "A2A_API_KEY"
...
output "agent_competitor_analyst_a2a_url" {
  description = "The public URL of the Competitor Analyst A2A Agent"
  value       = "https://ca-agent-competitor-analyst-a2a.${azapi_resource.container_app_environment.output.properties.defaultDomain}"
}

output "agent_competitor_analyst_a2a_agent_card" {
  description = "The A2A Agent Card URL for discovery"
  value       = "https://ca-agent-competitor-analyst-a2a.${azapi_resource.container_app_environment.output.properties.defaultDomain}/.well-known/agent-card.json"
}
